...
1. Générer l'installeur avec `pnpm build:win` (voir Développement), puis lancer `dist/Claude Usage Setup x.x.x.exe`. L'installation se fait sans droits administrateur.
